      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 w-full">
        <div className="mb-16 text-center gsap-reveal">
          ...
          <p style={{ fontFamily: 'var(--font-body)', fontSize: '1.125rem', color: 'var(--color-text-tertiary)' }}>
            Badges de formación — validación continua de competencias.
          </p>
        </div>
        ...
        <div className="mx-auto max-w-2xl space-y-4">
          {certs.length > 0 ? certs.map((c, i: number) => (
            ...
            <p className="text-text-muted text-center py-8 gsap-reveal">Cargando certificaciones desde LinkedIn...</p>
          )}
          ...
          <div className="gsap-reveal">
            <GlassCard className="mt-6">
              ...
              <p className="text-text-secondary text-sm mb-3">
                Certificaciones validadas en LinkedIn. Especializado en seguridad industrial, mantenimiento, datos y automatización.
              </p>
              <div className="flex flex-wrap gap-2">
                {['Power BI', 'Python', 'SQL', 'Arduino', 'IoT', 'Automatización',
                  'Mantenimiento Preventivo', 'SST', 'PLC', 'SCADA',
                  'Machine Learning', 'ETL', 'Fotogrametría', 'Diseño 3D',
                  'Excel Avanzado', 'Visual Basic', 'Control Estadístico'].map(s => (
